...
FONT = resource_path('InstagramSans-Medium.ttf')

# FONT = "InstagramSans-Medium.ttf"
LabelBase.register(DEFAULT_FONT, FONT)
PLATFORM = platform

# live_domain = input("Live Domain (True/False) : ")

DEBUG = False
LIVE_DOMAIN = False

# if(live_domain in ["", "True", "true", "t", "T"]):
#     LIVE_DOMAIN = True
# elif(live_domain in ["False", "false", "f", "F"]):
#     LIVE_DOMAIN = False
# else:
#     quit()
    ...
    MDScreen:
        ...
        MDBoxLayout:
            ...
            MDTopAppBar:
                ...
                right_action_items : [["chart-box", lambda x: app.view_attendance_report()], ["account-plus", lambda x: app.redirect_to_add_student_screen()], ["check", lambda x: app.mark_attendance_dialog_callback()]]
                md_bg_color : app.theme_color
                elevation : 0
    ...
    MDScreen:
        ...
        MDBoxLayout:
            ...
            MDTopAppBar:
                ...
                title : "Add Student"
                left_action_items : [["arrow-left", lambda x : app.redirect_to_mark_attendance_screen_backward()]]
                right_action_items : [["plus", lambda x : app.add_student_manually_dialog_callback()]]
                md_bg_color : app.theme_color
                elevation : 0
            ...
            MDBoxLayout:
                ...
                MDRaisedButton:
                    ...
                    id : add_student_bluetooth_scan_button
                    text : "Scan"
                    font_size : "18sp"
                    pos_hint : {'center_x' : 0.5, 'center_y' : 0.5}
                    md_bg_color : app.theme_color
                    size_hint : (0.5, 1)
                    on_release : app.add_student_bluetooth_scan()
                    ...
                    MDSpinner:
                        id : add_student_bluetooth_scan_spinner
                        color : [1, 1, 1, 1]
                        size_hint: None, None
                        size: dp(16), dp(16)
                        line_width : "1.5dp"
...
class App(MDApp):
    ...
    def __init__(self, **kwargs):
        ...
        self.control_dict = {
            ...
            "add_student_bluetooth_scan_snackbar_message" : None,
            "add_student_bluetooth_scan_snackbar" : False,
            "show_scanned_devices" : False,
            "reset_add_student_bluetooth_scan_button" : False,
            "add_student_bluetooth_scan_message" : None,
            "show_add_student_bluetooth_scan_message" : False,

            "add_student_snackbar_message" : None,
            "add_student_snackbar" : False,
        }
    ...
    def control_method(self, dt):
        ...
        if (self.control_dict["sign_in_snackbar"]):
            ...
            self.root.ids.sign_in_spinner.opacity = 0
        ...
        if (self.control_dict["show_threads"]):
            ...
            for thread in self.control_dict["threads"]:
                ...
                md_card.id=f"{thread[1]}"
                md_card.add_widget(md_relative_layout)
                self.root.ids.thread_list.add_widget(md_card)
        ...
        if (self.control_dict["show_replies_message"]):
            ...
            try:
                self.root.ids.thread_discussions.remove_widget(self.replies_message)
            except:
                pass
            try:
                self.root.ids.thread_discussions.remove_widget(self.replies_spinner)
            except:
                pass
        ...
        if (self.control_dict["show_attendance"]):
            ...
            for attendance in self.control_dict["attendance"]:
                ...
                md_card.add_widget(md_relative_layout)
                self.root.ids.attendance_list.add_widget(md_card)
        ...
        if(self.control_dict["show_courses"]):
            ...
            for course in self.control_dict["courses"]:
                ...
                md_card.add_widget( md_relative_layout)
                md_card.id = f"{course[1]}${course[2]}"
                self.root.ids.courses_list.add_widget(md_card)
        ...
        if(self.control_dict["show_add_student_bluetooth_scan_message"]):
            self.control_dict["show_add_student_bluetooth_scan_message"] = False
            self.root.ids.add_student_bluetooth_scan_button.disabled = False
            self.root.ids.add_student_bluetooth_scan_spinner.active = False

            try:
                self.root.ids.add_student_screen.remove_widget(self.add_student_message)
            except:
                pass
            try:
                self.root.ids.add_student_screen.remove_widget(self.add_student_spinner)
            except:
                pass
            try:
                self.root.ids.add_student_list.remove_widget(self.device_table)
            except:
                pass

            self.add_student_message = MDLabel(
                text=self.control_dict["add_student_bluetooth_scan_message"],
                halign="center"
            )
            self.root.ids.add_student_screen.add_widget(self.add_student_message)

        if(self.control_dict["add_student_bluetooth_scan_snackbar"]):
            self.control_dict["add_student_bluetooth_scan_snackbar"] = False
            Snackbar(
                text=self.control_dict["add_student_bluetooth_scan_snackbar_message"],
                snackbar_x="9dp",
                snackbar_y="9dp",
                size_hint_x=0.95,
                duration=1.5
        ...
        if(self.control_dict["show_scanned_devices"]):
            self.control_dict["show_scanned_devices"] = False
            self.root.ids.add_student_bluetooth_scan_button.disabled = False
            self.root.ids.add_student_bluetooth_scan_spinner.active = False
            ...
            row_data = []
            for index, device in  enumerate(self.control_dict["scanned_devices"]):
                row_data.append((f"{index + 1}", f"{device[0]}", f"{device[1]}"))

            self.device_table = MDDataTable(
            use_pagination=True,
            check=False,
            column_data=[
                ("S.No.", dp(30)),
            ...
            self.device_table.bind(on_row_press=self.add_student_dialog_callback)
            self.root.ids.add_student_list.add_widget(self.device_table)

        if(self.control_dict["reset_add_student_bluetooth_scan_button"]):
            self.control_dict["reset_add_student_bluetooth_scan_button"] = False
            self.root.ids.add_student_bluetooth_scan_button.disabled = False
            self.root.ids.add_student_bluetooth_scan_spinner.active = False

        if(self.control_dict["add_student_snackbar"]):
            self.control_dict["add_student_snackbar"] = False
            Snackbar(
                text=self.control_dict["add_student_snackbar_message"],
                snackbar_x="9dp",
                snackbar_y="9dp",
                size_hint_x=0.95,
                duration=1.5
            ).open()
            self.redirect_to_mark_attendance_screen_backward()
    ...
    def select_path(self, path):
        ...
        self.upload_file_button.add_widget(self.upload_file_spinner)
    ...
    def sign_in_thread(self):  # Thread_3
        ...
        if (response.status_code == 200):
            ...
            self.control_dict["sign_in_snackbar_message"] = response.json()[
                "message"]
            self.control_dict["sign_in_snackbar"] = True
            self.control_dict["reset_components"] = True
    ...
    def sign_in(self):
        ...
        self.root.ids.sign_in_spinner.opacity = 1
    ...
    def reset_control_dict(self):
        ...
        self.control_dict["add_student_bluetooth_scan_snackbar_message"] = None
        self.control_dict["add_student_bluetooth_scan_snackbar"] = False
        self.control_dict["show_scanned_devices"] = False
        self.control_dict["reset_add_student_bluetooth_scan_button"] = False
        self.control_dict["add_student_bluetooth_scan_message"] = None
        self.control_dict["show_add_student_bluetooth_scan_message"] = False

        self.control_dict["add_student_snackbar_message"] = None
        self.control_dict["add_student_snackbar"] = False
    ...
    def file_actions(self, file_name):
        ...
        self.download_file_button.add_widget(self.download_file_spinner)
        ...
        self.delete_file_button.add_widget(self.delete_file_spinner)
    ...
    def create_thread_dialog_callback(self):
        ...
        self.create_thread_button.add_widget(self.create_thread_spinner)
    ...
    def delete_thread_dialog_callback(self, thread_name):
        ...
        self.delete_thread_button.add_widget(self.delete_thread_spinner)
    ...
    def build_faculty_dashboard(self):
        ...
        self.faculty_dashboard_box_layout.add_widget(md_card)
    ...
    def add_course_dialog_callback(self):
        ...
        self.add_course_button.add_widget(self.add_course_spinner)
    ...
    def add_course(self, course_name, course_code, batch):
        ...
        if(len(course_name) == 0 or len(course_code) == 0 or len(batch) == 0):
            return
    ...
    def mark_attendance_dialog_callback(self):
            ...
            if(self.control_dict["students"] == None or len(self.control_dict["students"]) == 0):
                ...
                self.mark_attendance_button.add_widget(self.mark_attendance_spinner)
    ...
    def add_student_thread(self, student_username, mac_address):
        
        url = self.domain + "/api/add_student/"
        ...
        try:
            ...
            self.add_student_dialog_spinner.active = False
            self.add_student_dialog_spinner.color = [1, 1, 1, 1]
            self.add_student_button.disabled = False
            self.control_dict["add_student_snackbar_message"] = "Failed to connect to server."
            self.control_dict["add_student_snackbar"] = True
            return
        ...
        self.add_student_dialog_spinner.color = [1, 1, 1, 1]
        self.add_student_button.disabled = False
        self.control_dict["add_student_snackbar_message"] = response.json()["message"]
        self.control_dict["add_student_snackbar"] = True

    def add_student(self, student_username, mac_address):
        if(len(student_username) == 0 or len(mac_address) == 0):
            return
        
        self.add_student_button.disabled_color = [245/255, 245/255, 245/255, 1]
        self.add_student_dialog_spinner.color = self.theme_color
        self.add_student_button.disabled = True
        self.add_student_dialog_spinner.active = True

        threading.Thread(target=self.add_student_thread, args=(student_username, mac_address)).start()
    
    def add_student_manually_dialog_callback(self):
        ...
        student_username_label = MDTextField(
        ...
        add_student_box_layout.add_widget(student_username_label)

        mac_label = MDTextField(
        ...
        add_student_box_layout.add_widget(mac_label)

        self.add_student_dialog_spinner = MDSpinner(
            color=[1, 1, 1, 1],
            size_hint=(None, None),
            size=(dp(16), dp(16)),
            line_width = "2dp",
        ...
        self.add_student_button = MDFlatButton(
            text="ADD",
            on_release = lambda button: self.add_student(student_username_label.text, mac_label.text)
        )
        self.add_student_button.add_widget(self.add_student_dialog_spinner)
        ...
        self.add_student_dialog = MDDialog(
            ...
            pos_hint = {"center_x" : 0.5, "center_y" : 0.6},
            type = "custom",
            content_cls = add_student_box_layout,
            buttons=[
                MDFlatButton(
                    text="CANCEL",
                    on_release=lambda button: self.add_student_dialog.dismiss()
                ),
    ...
    def add_student_bluetooth_scan_thread(self):
        
        try:
            devices = self.get_nearby_devices()
        except:
            self.control_dict["add_student_bluetooth_scan_snackbar_message"] = "Failed to connect to bluetooth."
            self.control_dict["add_student_bluetooth_scan_snackbar"] = True
            return

        
        self.control_dict["scanned_devices"] = devices
        if (len(devices) == 0):
            self.control_dict["add_student_bluetooth_scan_message"] = "No devices found."
            self.control_dict["show_add_student_bluetooth_scan_message"] = True
        else:
            self.control_dict["show_scanned_devices"] = True
        
        self.control_dict["reset_add_student_bluetooth_scan_button"] = True

    def add_student_bluetooth_scan(self):

        self.root.ids.add_student_bluetooth_scan_button.disabled = True
        self.root.ids.add_student_bluetooth_scan_spinner.active = True
        threading.Thread(target=self.add_student_bluetooth_scan_thread).start()

    def redirect_to_add_student_screen(self):
        self.root.transition.direction = "left"
        self.root.current = "add_student_screen"
    ...
    def get_nearby_devices(self):
        ...
        if(self.platform == "win"):
            ...
            class MyReceiver:
                def __init__(self):
                    self.receiver = BroadcastReceiver(self.on_receive, actions=['android.bluetooth.device.action.FOUND'])
                    self.receiver.start()
                ...
                def on_receive(self, context, intent):
                    ...
                    if action == 'android.bluetooth.device.action.FOUND':
                        ...
                        if name and [name, address] not in discovered_devices:
                            discovered_devices.append([name, address])
            ...
            # Let it run for a few seconds (5–8 seconds is common)
            start_time = time()
            while time() - start_time < 8:
                sleep(0.5)  # non-blocking friendly

            # Stop discovery and receiver
            if adapter.isDiscovering():
                adapter.cancelDiscovery()
            receiver.stop()
